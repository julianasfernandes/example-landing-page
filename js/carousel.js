function Carousel(config){
    ...
    function init(){
        ...
        /*o código acima tira a classe show(mostar primeiro) de todas as imagens e o abaixo, coloca o show apenas no primeiro item, indice 0*/
    ...
    function showSlide(){
        ...
        slide = Math.abs(slide); /*retorna valor absoluto, ou seja, não retorna número negativo*/
